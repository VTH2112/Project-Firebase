...
`;
class job_card_active extends HTMLElement {
  constructor() {
    super();
    this.attachShadow({
      mode: "open",
  ...
  connectedCallback() {
    ...
    ${jobCardCss}
    <div class="job_card_active  card" style="width: 20rem;">
         ...
         <div class="card-body">
                ...
                <a href="#" class="btn btn-primary bg-danger" id="delete-active">Delete</a>
                </div>
    </div>
    </div>
    `;
...
customElements.define("job-card-active", job_card_active);
